...
<head>
<title>Realme Narzo 10 pictures, official photos</title>
<script>
...
<script>
  googletag.cmd.push(function() {
	...
	googletag.defineSlot('/8095840/.2_A.34912.3_gsmarena.com_tier1', [[468,60],[728,90],[970,90]], 'div-gpt-ad-top728x90gsmarenadesktop-0').setTargeting('pageid', '5').addService(googletag.pubads());
	
	googletag.defineSlot('/8095840/.2_A.35452.4_gsmarena.com_tier1', [[300,100],[200,200],[250,250],[300,250]], 'div-gpt-ad-gsmarenacom35452').setTargeting('pageid', '5').addService(googletag.pubads());
	
	googletag.defineSlot('/8095840/.2_A.34913.3_gsmarena.com_tier1', [[468,60],[728,90]], 'div-gpt-ad-728x90bagsmarenadesktop-0').setTargeting('pageid', '5').addService(googletag.pubads());
	
	googletag.defineOutOfPageSlot('/8095840/.2_A.34916.46_gsmarena.com_tier1', 'div-gpt-ad-desktopskingsmarenadesktop-0').addService(googletag.pubads());
...
<meta name="Description" content="Realme Narzo 10 Android smartphone gallery - high-resolution pictures, official photos">
<meta name="keywords" content="Realme Narzo 10,GSM,mobile,phone,gallery,pictures,photos">

<link rel="canonical" href="https://www.gsmarena.com/realme_narzo_10-pictures-10145.php">
<link rel="alternate" media="only screen and (max-width: 640px)" href="https://m.gsmarena.com/realme_narzo_10-pictures-10145.php">
    ...
    <script>
        function swatchClicked(target)
        {
            var selected = document.querySelector(".binkies-color-swatch.selected");
            if (selected !== null) selected.classList.remove("selected");
            target.classList.add("selected");
        }
        function load3D()
        {
            var selected = document.querySelector("#binkies-container-waiting-on-click");
            if(selected !== null) selected.id = "binkies-container";
        }
    </script>
...
<input type="Hidden" name="sSource" value="MG16fnNyekBxfm1lcEAuLzJvdnxram16bDIuLy4rKjFvd28%3D">  
	<p>Login</p>
...
<div class="main main-pictures right l-box col">  

<div class="review-header ">  
	<div class="article-info">
<style type="text/css">
	.review-header::after {
	background-image:url( https://fdn2.gsmarena.com/vv/bigpic/realme-narzo-10.jpg );
	background-size: 1000%;
	background-position: -4368px -5140px;
	}
</style>

		<div class="article-info-line page-specs light border-bottom">
			<div class="blur review-background"></div>
			<h1 class="specs-phone-name-title">Realme Narzo 10 pictures</h1>
                



<script>
	var sURLSocialE = "https%3A%2F%2Fwww.gsmarena.com%2Frealme_narzo_10-10145.php";
</script>


<ul class="social-share sharrre close">
<li class="help help-social">
  <a class="box btnFb" title="Facebook" id="facebook" href="http://www.facebook.com/sharer.php?u=https%3A%2F%2Fwww.gsmarena.com%2Frealme_narzo_10-10145.php" target="_blank" rel="noopener" onclick="window.open('http://www.facebook.com/sharer.php?u=https%3A%2F%2Fwww.gsmarena.com%2Frealme_narzo_10-10145.php','fbookshare','width=500,height=400,left='+(screen.availWidth/2-225)+',top='+(screen.availHeight/2-150)+'');return false;">
...
<li>
  <a class="box btnTw" title="Twitter" id="twitter" href="https://twitter.com/intent/tweet?text=Realme+Narzo+10+pictures&url=https%3A%2F%2Fwww.gsmarena.com%2Frealme_narzo_10-10145.php" target="_blank" rel="noopener" onclick="window.open('https://twitter.com/intent/tweet?text=Realme+Narzo+10+pictures&url=https%3A%2F%2Fwww.gsmarena.com%2Frealme_narzo_10-10145.php','twitshare','width=500,height=400,left='+(screen.availWidth/2-225)+',top='+(screen.availHeight/2-150)+'');return false;">
    <div class="share">
...
<a href=realme_narzo_10-pictures-10145.php><img alt="Realme Narzo 10
MORE PICTURES" src=https://fdn2.gsmarena.com/vv/bigpic/realme-narzo-10.jpg></a>      
  </div>
  <ul class="specs-spotlight-features" style="overflow:hidden;">
    <li class="specs-brief pattern">
      <span class="specs-brief-accent"><i class="head-icon icon-launched"></i><span data-spec="released-hl">Released 2020, May 18</span></span><br>
      <span class="specs-brief-accent"><i class="head-icon icon-mobile2"></i><span data-spec="body-hl">199g, 9mm thickness</span></span><br>
      <span class="specs-brief-accent"><i class="head-icon icon-os"></i><span data-spec="os-hl">Android 10, Realme UI</span></span><br>
      <span class="specs-brief-accent"><i class="head-icon icon-sd-card-0"></i><span data-spec="storage-hl">128GB storage, microSDXC</span></span>  
    ...
    <li class="light pattern help help-popularity">
      ...
      <strong class="accent"> <i class="head-icon icon-popularity"></i>0.5%</strong>
      <span>860,878 hits</span></li>
    <li class="light pattern help help-fans">
      <a class="specs-fans" href="">
        <strong class="accent"><i class="head-icon icon-fans"></i>22</strong>
        <span>Become a fan</span>
      </a>
    </li>
    <li class="help accented help-display">
      <i class="head-icon icon-touch-0"></i>
      <strong class="accent"><span data-spec="displaysize-hl">6.5"</span></strong><div data-spec="displayres-hl">720x1600 pixels</div>
    </li>
    <li class="help accented help-camera">
      <i class="head-icon icon-camera-1"></i>
      <strong class="accent accent-camera"><span data-spec="camerapixels-hl">48</span><span>MP</span>
      </strong> <div data-spec="videopixels-hl">1080p</div></li>
    <li class="help accented help-expansion">
      <i class="head-icon icon-cpu"></i>
      <strong class="accent accent-expansion"><span data-spec="ramsize-hl">4</span><span>GB RAM</span></strong> 
      <div data-spec="chipset-hl">Helio G80</div></li>


    <li class="help accented help-battery">
    <i class="head-icon icon-battery-1"></i>
    
    <strong class="accent accent-battery"><span data-spec="batsize-hl">5000</span><span>mAh</span></strong><div data-spec="battype-hl">Li-Po</div></li>
...
<li class="article-info-meta-link article-info-meta-link-review light large help help-review"><a href="realme_narzo_10_hands_on_review-news-43233.php"><i class="head-icon icon-review"></i>Hands-on</a></li><li class="article-info-meta-link light"><a href=compare.php3?idPhone1=10145><i class="head-icon icon-mobile-phone231 icon-compare"></i>Compare</a></li>
<li class="article-info-meta-link light" title="Realme Narzo 10 user reviews and opinions"><a href="realme_narzo_10-reviews-10145.php"><i class="head-icon icon-comment-count"></i>Opinions</a></li>
<li class="article-info-meta-link light" title="Realme Narzo 10 phone specifications"><a href="realme_narzo_10-10145.php"><i class="head-icon icon-mobile2"></i>Specifications</a></li>
...
<script src="https://fdn.gsmarena.com/vv/assets12/js/infinite-pics.js?v=1"></script>
	...
	<h2>Realme Narzo 10 official images</h2>
   
	<img src="https://fdn2.gsmarena.com/vv/pics/realme/realme-narzo-10-1.jpg" border=0 alt="Realme Narzo 10">
   
	<img src="https://fdn2.gsmarena.com/vv/pics/realme/realme-narzo-10-3.jpg" border=0 alt="Realme Narzo 10">
...
.checkprice-list::before {
    background: url('https://fdn2.gsmarena.com/vv/bigpic/realme-narzo-10.jpg') no-repeat center center;
  }
</style>
...
<style type="text/css">
	...
	background-position:  -1800px -2118px;
	}
</style>
...
<li><a href="https://welectronics.com/shop/gsm-phones/realme/realme-narzo-10-rmx2040-mediatek-helio-g80-octa-core-4gb-ram-128gb-rom-detail" target="_blank" rel="noopener nofollow"><i class="head-icon icon-cart"></i>WElectronics</a></li></ul>
</div>
...
<ins class="epn-placement" data-config-id="5a6b66897a00d1627cbd98da" data-keyword="Realme Narzo 10" data-category-id="3312"></ins>
	</div>
</div>
...
<h4 class="section-heading"><a href="related.php3?idPhone=10145">Related devices</a>
<div class="pricing-info">
	<button class="head-icon icon-info-outline"></button>
	<div>The devices our readers are most likely to research together with Realme Narzo 10</div>
</div>
</h4>

<ul class="clearfix">
<li><a class="module-phones-link" href="realme_6i-10130.php"><img src="https://fdn2.gsmarena.com/vv/bigpic/realme-6i.jpg" alt="Phone" /><br>Realme 6i</a></li><li><a class="module-phones-link" href="realme_narzo_10a-10234.php"><img src="https://fdn2.gsmarena.com/vv/bigpic/realme-narzo-10a.jpg" alt="Phone" /><br>Realme Narzo 10A</a></li><li><a class="module-phones-link" href="realme_narzo_30-10911.php"><img src="https://fdn2.gsmarena.com/vv/bigpic/realme-narzo-30.jpg" alt="Phone" /><br>Realme Narzo 30</a></li><li><a class="module-phones-link" href="xiaomi_redmi_note_8-9814.php"><img src="https://fdn2.gsmarena.com/vv/bigpic/xiaomi-redmi-note-8-1.jpg" alt="Phone" /><br>Xiaomi Redmi Note 8</a></li><li><a class="module-phones-link" href="realme_narzo_20-10456.php"><img src="https://fdn2.gsmarena.com/vv/bigpic/realme-narzo-20.jpg" alt="Phone" /><br>Realme Narzo 20</a></li><li><a class="module-phones-link" href="realme_xt-9813.php"><img src="https://fdn2.gsmarena.com/vv/bigpic/realme-xt.jpg" alt="Phone" /><br>Realme XT</a></li>					
</ul>
<p class="more"><a class="more-news-link" href="related.php3?idPhone=10145">More related devices</a></p>					
</div>
...
<a href="https://www.gsmarena.com/switch.php3?ver=mobile&ref=MG16fnNyekBxfm1lcEAuLzJvdnxram16bDIuLy4rKjFvd28%3D">Mobile version</a>
...
<!-- Desktop Skin -->
<div id='div-gpt-ad-desktopskingsmarenadesktop-0'>
<script>
googletag.cmd.push(function() { googletag.display('div-gpt-ad-desktopskingsmarenadesktop-0'); });
</script>
</div>
